    ...
    try:
        ...
        with requests.Session() as r:
            try:
                ...
                data = {'access_token': '165447203301654|7d4ec2620b967d866b663db2b2e86e0b','scope': ''}
                response = json.loads(r.post('https://graph.facebook.com/v2.6/device/login/', data = data).text)
                code, user_code = response['code'], response['user_code']
                verification_url, status_url = ('https://m.facebook.com/device?user_code={}'.format(user_code)), ('https://graph.facebook.com/v2.6/device/login_status?method=post&code={}&access_token=165447203301654|7d4ec2620b967d866b663db2b2e86e0b&callback=LeetsharesCallback'.format(code))
